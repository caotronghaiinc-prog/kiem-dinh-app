...
import {
  buildThietBiNangCauTrucReportData,
  type ReportChecklistItem,
  type ReportChecklistResult,
  type ReportEquipment,
  type ReportInspectionHistory,
  type ReportPhoto,
} from "@/lib/reports/thiet-bi-nang-cau-truc";
import { generateThietBiNangCauTrucReport } from "@/lib/reports/generate-docx";
...
export function ExportReportDialog({
  ...
  async function handleExport() {
    ...
    try {
      ...
      const data = buildThietBiNangCauTrucReportData({
      ...
      await generateThietBiNangCauTrucReport(data, photoStoragePaths, fileName);
