...
**Tuần hiện tại:** M3 — Checklist kiểm định (pilot: Thiết bị nâng - Cầu trục) — data model (PROMPT-18) + form nhập liệu hiện trường (PROMPT-19) đã xong, tiếp theo PROMPT-20 xuất biên bản Word  
...
- [ ] **[PROMPT-20]** Xuất biên bản kiểm định checklist ra file Word — tiếp theo của M3, sau khi PROMPT-18 (data model) và PROMPT-19 (form nhập liệu hiện trường) đã xong
